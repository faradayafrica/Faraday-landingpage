    ...
    <section className='bg-journeyBg py-24 relative'>
      {/* <div className='container'>
        ...
        <h3
          ...
          className='max-w-[390px] mx-auto md:max-w-max font-extrabold text-[28px] md:text-[48px] mb-5 text-center mt-8
        before:absolute before:content-[""]  before:w-[40px] before:h-[40px] before:[background-size:_40px_40px] md:before:w-[60px] md:before:h-[60px] md:before:[background-size:_60px_60px] before:-mt-5 before:-ml-16 md:before:-ml-20
        after:absolute after:content-[""] after:w-[40px] after:h-[40px] after:[background-size:_40px_40px] md:after:w-[60px] md:after:h-[60px] md:after:[background-size:_60px_60px] after:-mt-12 after:ml-20 md:after:-mt-5 md:after:ml-[1rem] '
        >
